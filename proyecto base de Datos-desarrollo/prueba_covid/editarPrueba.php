...
<body>
    <div class="container mt-5">
        <form action="actualizarPrueba.php" method="POST">
            ...
            <input type="radio" name="incapacidad" value="si" <?php echo ($row['incapacidad']=='si')?'checked':'' ?>>si<br />
            <input type="radio" name="incapacidad" value="no" <?php echo ($row['incapacidad']=='no')?'checked':'' ?>>no<br />
            ...
            <input type="hidden" class="form-control mb-3" name="pruebaID" value="<?php echo $row['pruebaID']  ?>">
